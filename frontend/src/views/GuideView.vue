...
const SECTIONS = [
  ...
  },
  {
    ...
    summary: '最完整的板塊分析工具。上方全覽四個視圖掌握 17 個板塊相對位置，下方深度分析含 7 個動能指標、6 張圖表、VCP 選股清單。',
    howTo: [
    ...
    howRead: [
      ...
      '<b>RRG 四象限</b>：右上（領先）→ 右下（弱化）→ 左下（落後）→ 左上（改善）→ 循環；領先 + 持續向右上最強。',
    ...
    warnings: [
      '軌跡需至少 50 個交易日計算 RS Ratio，區間太短會顯示不完整。',
    ],
  },
  {
    id: 'sector-strength',
