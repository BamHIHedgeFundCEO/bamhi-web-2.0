...
TRACKED_SECTORS = {
    ...
    "稀土與戰略金屬 (Rare Earths)": ["MP", "UUUU", "AREC", "CRML", "NB", "TMC", "IDR", "PPTA", "UAMY", "USAR"],
    ...
    "算力租借平台 (AI Compute Infra)": ["NBIS","CRWV", "APLD", "CORZ", "IREN", "WULF", "BTDR", "HUT","HIVE","CIFR","RIOT","CLSK","MARA","GLXY","KEEL"],
    ...
    "加密貨幣(Crypto)": ["MSTR", "COIN", "GLXY", "CRCL", "BKKT", "CNCK", "EXOD", "BTCS", "MARA", "RIOT", "CLSK", "IREN", "HUT", "CIFR", "WULF", "BTBT", "ARBK", "BTDR", "CORZ", "APLD", "CAN", "NA", "NCTY", "BGIN", "ICG", "GPUS", "ABTC"],
    ...
    "機器人 (Robotics)": ["TSLA", "ISRG", "SYM", "SERV", "KSCP", "PATH", "ABB", "NNDM", "PDYN"],
    ...
    "資安 (Cybersecurity)": ["CRWD", "PANW", "ZS", "FTNT", "S", "NET", "OKTA", "TENB", "QLYS", "RPD", "VRNS", "GEN", "FFIV", "RBRK", "AKAM", "ATEN", "DDOG", "CHKP", "YOU"],
    ...
    "太陽能 (Solar)": ["FSLR", "ENPH", "NXT", "SEDG", "RUN", "ARRY", "SHLS", "FLNC", "CSIQ", "JKS", "MAXN", "NOVA", "TE"],
    "電動車 (Electric Vehicles)": ["TSLA", "RIVN", "LI", "LCID", "NIO", "XPEV", "BYDDY", "ZK", "PSNY"],
    "金融科技與支付 (Fintech & Payments)": ["V", "MA", "XYZ", "PYPL", "FI", "GPN", "SOFI", "AFRM", "NU", "UPST", "KLAR", "SEZL", "TOST", "BILL", "DLO", "HOOD"],
    "黃金礦 (Gold Miners)": ["NEM", "AEM", "GOLD", "WPM", "FNV", "AGI", "KGC", "RGLD", "GFI", "AU", "HMY", "BTG", "EGO", "IAG", "PAAS", "SSRM", "NGD", "OR"],
    "水泥砂石 (Aggregates & Cement)": ["AMRZ", "VMC", "MLM", "CRH", "EXP", "KNF", "GVA", "USLM", "CX", "BBCP", "RMIX"],
    "住宅建材 (Building Materials)": ["BLDR", "WLK", "JHX", "QXO", "BLD", "OC", "MAS", "TREX", "SMID", "SSD", "NX", "WMS", "ATKR", "ROCK", "PATK", "FBIN", "UFPI", "LPX", "BCC"],
    "鋼鐵金屬 (Steel & Metals)": ["NUE", "RS", "CMC", "STLD", "CLF", "WS", "ZEUS", "RYI", "RDUS", "CENX", "AA"]
}
...
SECTOR_LEADERS = {
    ...
    "水泥砂石 (Aggregates & Cement)": ["VMC", "MLM", "CRH"],
    "住宅建材 (Building Materials)": ["BLDR", "QXO", "WMS"],
    "鋼鐵金屬 (Steel & Metals)": ["NUE", "STLD", "RS"]
}
